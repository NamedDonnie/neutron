...
public class ImageBackground {
    ...
    public static final String DEST = "neutron-service/src/test/pdf/imagebackground.pdf";
    public static final String IMG1 = "neutron-service/src/test/images/bruno.jpg";
    ...
    public void createPdf(String dest) throws IOException, DocumentException {
        ...
        PdfWriter.getInstance(document, new FileOutputStream(dest));//生成PdfWriter实例
        document.open();
